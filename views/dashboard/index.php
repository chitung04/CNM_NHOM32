...
<div class="container-fluid px-0">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="welcome-card">
                ...
                <p class="mb-0">Chào mừng bạn đến với DUO PHARMA</p>
            </div>
        </div>
    </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3">
            <a href="index.php?page=reports&action=expiry" class="text-decoration-none">
                <div class="card stat-card h-100">
                    <div class="card-body text-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <?php if (isManager()): ?>
                        <div class="col-md-3">
                            <a href="view_audit_logs.php" class="btn btn-outline-secondary w-100 py-3">
                                ...
                                <a href="index.php?page=sales&action=invoice&id=<?= $invoice['invoice_id'] ?>" 
                                   class="list-group-item list-group-item-action">
                                    <div class="d-flex w-100 justify-content-between">
                                        ...
                                        <small><?= $invoice['created_at'] ? date('d/m/Y H:i', strtotime($invoice['created_at'])) : '-' ?></small>
                                    </div>
                                    <p class="mb-1">
                            ...
                            <?php foreach ($notifications as $notif): ?>
                                <div class="list-group-item">
                                    <div class="d-flex w-100 justify-content-between">
                                        ...
                                        <small><?= $notif['created_at'] ? date('d/m/Y', strtotime($notif['created_at'])) : '-' ?></small>
                                    </div>
